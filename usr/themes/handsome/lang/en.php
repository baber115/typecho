    ...
    */
    public function translated(){
        return array(
            ...
            '标签统计图' => 'Tag Chart',
            '统计近10个月的博主文章和评论数目' => 'Count the number of articles and author reviews over the last 10 months',
            '以及github账户 %s 的提交记录' => 'And submission data of GitHub account %s',
            '外观设置' => 'Preference',
            '深色模式' => 'Dark Mode',
            ...
            '无法获取当前评论(评论已复制到剪切板)，可能原因如下：'=>'Unable to get the current comment for the following possible reasons:',
