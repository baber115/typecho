    ...
    <a href="<?php $this->options->rootUrl(); ?>/" class="navbar-brand text-lt">
        <span id="navbar-brand-day">
            ...
            <?php else: ?>
                ...
                <?php else: ?>
                    <?php echo ScodeParse::returnIconHtml($this->options->indexNameIcon); ?>
                <?php endif; ?>
                ...
                <div class="row">
                    <div class="col-sm-8 b-l b-light">
                        ...
                        <div class="text-muted m-l-xs " style="font-size: 12px"><?php
                            _me("统计近10个月的博主文章和评论数目");$github = Utils::getExpertValue("calendar_github");($github ? _me("以及 <a class='highlightlink' href='https://github.com/%s' target='_blank'>GitHub 账户 %s </a> 的提交记录",$github,$github) :"")?></div>
                        ...
                        <div class="list-group" id="smallRecording">
                            ...
                            if ($page) {
                                ...
                                foreach ($comments AS $comment) {
                                    ...
                                    echo '<a href="'.BLOG_URL_PHP.'cross.html" class="list-group-item"><span class="clear block m-b-none words_contents">'.CommonContent::excerpt($content,200).'<br><small class="text-muted">'.Utils::formatDate($comments,$comment['created'],
