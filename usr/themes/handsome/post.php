...
:?>
    ...
    $data['md5'] = Utils::md5($rData['password']);
    $data['type'] = "category";
   ...
   <main class="app-content-body <?php Content::returnPageAnimateClass($this); ?>">
    ...
    <!--标题下的一排功能信息图标：作者/时间/浏览次数/评论数/分类-->
      <?php echo Content::exportPostPageHeader($this,$this->user->hasLogin()); ?>
       <!--文章标题下面的小部件-->
         <?php if (PostContent::isImageCategory($this->categories)): ?>
      ...
      <div class="wrapper-md">
       ...
       <div id="postpage" class="blog-post">
        ...
        <!--文章页面的头图-->
        <?php if (!PostContent::isImageCategory($this->categories)) echo Content::exportHeaderImg($this); ?>
         <!--文章内容-->
